...
FORCE_SUB_CHANNEL = environ.get("FORCE_SUB_CHANNEL", "Railway_FOUNDETION")  # Channel username without @, 
FORCE_SUB_CHANNEL_LINK = environ.get("FORCE_SUB_CHANNEL_LINK", "https://t.me/Railway_FOUNDETION")  # Channel link
