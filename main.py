        ...
        if FORCE_SUB_CHANNEL:
            ...
            if not is_sub:
                keyboard = InlineKeyboardMarkup([
                    [InlineKeyboardButton("🔔 Join Channel", url="https://t.me/Railway_FOUNDETION")],
...
async def start(bot: Client, m: Message):
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [
            InlineKeyboardButton("🔔 Channel", url="https://t.me/Railway_FOUNDETION"),
            InlineKeyboardButton("👨‍💻 Developer", url="https://t.me/Railway_FOUNDETION")
        ]
    ])
